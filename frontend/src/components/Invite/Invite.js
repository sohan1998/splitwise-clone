...
import { Button, Grid, Row, Col, ListGroup, Form, Card, Modal } from 'react-bootstrap';
...
export default class Invite extends Component {
    ...
    handleModalSubmit = (e) => {
        ...
        axios.post(`${backendServer}/groups/acceptinvite`, data).then((response) => {
    ...
    render() {
        ...
        return (
            <div>
                <center>
                    <h2>Click on the following groups to accept invite</h2>
                </center>
                <br></br>
                <br></br>
                <br></br>
