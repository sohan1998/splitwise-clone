...
class Grouppage extends Component {
    ...
    handleSubmit = (e, data) => {
        ...
        axios.post(`${backendServer}/bills/addcomment`, data_for_comment).then((response) => {
            if (response.status === 200) {
                axios.post(`${backendServer}/bills/getallbills`, data).then((response) => {
    ...
    handleLeaveGroup = (e) => {
        ...
        axios.post(`${backendServer}/groups/leavegroup`, data).then((response) => {
    ...
    handleCommentDelete = (e, cid, bid) => {
        ...
        axios.post(`${backendServer}/bills/deletecomment`, dataforcomments).then((response) => {
    ...
    handleBillSubmit = (e) => {
        ...
        axios.post(`${backendServer}/bills/addbill`, data).then((response) => {
    ...
    async componentDidMount() {
        ...
        await axios.post(`${backendServer}/groups/getgroupmembers`, dataforgroups).then((response) => {
        ...
        await axios.post(`${backendServer}/bills/getallbills`, data).then((response) => {
            console.log('Got response for get all bills');
            console.log(response.data.allbillsinfo);
            this.setState({
                allbillsinfo: response.data.allbillsinfo,
        ...
        await axios.post(`${backendServer}/groups/fetchemails`, data).then((response) => {
        ...
        return (
            <div>
                ...
                <div className='d-flex my-3 justify-content-center'>
                    ...
                    <Link to='/dashboard' onClick={this.handleLeaveGroup} className='btn btn-primary'>
                        Leave Group
                    </Link>
                </div>
                <div className='row'>
                            ...
                            <Modal.Body>
                                <Form>
                                    <Form.Group controlId='formBasicEmail'>
                                        ...
                                        <Form.Control type='text' placeholder='Enter description' onChange={this.handleDescription} />
                                    </Form.Group>
                                    <Form.Group controlId='formBasicEmail'>
                                        <Form.Label>Amount</Form.Label>
                                        <Form.Control type='text' placeholder='Enter amount' onChange={this.handleAmount} />
                                    </Form.Group>
                                </Form>
                            </Modal.Body>
                            <Modal.Footer>
                                <Button onClick={this.handleModalClose}>Close Bill</Button>
                                <Button onClick={this.handleBillSubmit}>Save Changes</Button>
                            </Modal.Footer>
                        </Modal>
                        <br></br>
                        ...
                        {this.state.allbillsinfo.map((user) => (
                            <div class='thuscontainer'>
                                <div className='d-flex my-1 border 1px'>
                                    <ul>
                                        <li>
                                            <b>Description:</b> {user.billdescription}
                                            <br></br>
                                            <b>Amount:</b> {user.billamount}
                                        </li>
                                    </ul>
                                </div>
                                <div className='d-flex flex-column-reverse border 1px'>
                                    {user.billcomments.map((comment) => (
                                        <div className='d-flex my-1 border 1px'>
                                            ...
                                            <div>
                                                <button
                                                    type='button'
                                                    className='delButton btn-danger'
                                                    onClick={(e) => {
                                                        this.handleCommentDelete(e, comment.comment_id, user._id);
                                                    }}
                                                >
                                                    Delete Comment
                                                </button>
                                    ...
                                    <form>
                                        <input type='text' onChange={this.handleCommentChange}></input>
